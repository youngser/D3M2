...
def ase(datafn, dim=2):
    """
    Perform Adjacency Spectral Embedding on a matrix
    TODO: YP description
...
def main():
    parser = argparse.ArgumentParser(description="Python ASE wrapper")
